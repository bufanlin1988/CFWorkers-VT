...
// 建议修改为自己的 UUID
let userID = '862dfa15-3397-492b-a4b6-9ba09120b361';
...
// 用于 CF 网站的代理 IP
const proxyIPs = ['146.70.175.101']; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
/*
8.7.198.46
...
function getVLESSConfig(userID, hostName) {
    const vlessLink = `vless://${userID}\u0040${bestCFIP}:80?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#bufanlin-20240423-Vless`
    //const vlessTlsLink = `vless://${userID}\u0040${bestCFIP}:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#bufanlin-workers-TLS`
    return `
